...
export const TestimonialsSection = () => {
  const testimonials = [
    ...
    },
    {
      ...
      location: "Delhi",
      rating: 5,
      text: "As a working professional, I don't have time to go grocery shopping. Kartezy delivers everything I need - from fresh vegetables to household essentials - right to my doorstep. The app is super easy to use!",
