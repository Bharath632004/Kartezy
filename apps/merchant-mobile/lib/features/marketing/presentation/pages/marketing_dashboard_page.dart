                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount:
                                  (marketingState.sponsoredProducts ?? [])
                                      .length,
                              itemBuilder: (context, index) {
                                final product =
                                    marketingState.sponsoredProducts![index];
                                return Container(
                                  width: 120,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              scrollDirection: Axis.horizontal,
                              itemCount: (marketingState.featuredProducts ?? [])
                                  .length,
                              itemBuilder: (context, index) {
                                final product =
                                    marketingState.featuredProducts![index];
                                return Container(
                                  width: 120,
                                  margin: const EdgeInsets.only(right: 12),
                                  child: Card(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              scrollDirection: Axis.horizontal,
                              itemCount:
                                  (marketingState.bannerCampaigns ?? []).length,
                              itemBuilder: (context, index) {
                                final campaign =
                                    marketingState.bannerCampaigns![index];
                                return Container(
                                  width: 120,
                                  margin: const EdgeInsets.only(right: 12),
                                  child: Card(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'CTR: ${((campaign['clicks'] ?? 0) / (campaign['impressions'] ?? 1) * 100).toStringAsFixed(2)}%',
                                        ),
                                      ],
                                    ),
                                  ),
