...
class _OrderListPageState extends ConsumerState<OrderListPage>
  ...
  List<Map<String, dynamic>> _ordersForTab(int index) {
    ...
    switch (index) {
      case 0: return state.pendingOrders;
      case 1: return state.processingOrders;
      case 2: return state.deliveredOrders;
      case 3: return state.cancelledOrders;
      default: return [];
    }
  }
                    ...
                    if (orders.isEmpty) {
                      return Center(
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Icon(_statusIcon(index), size: 64, color: Colors.grey.shade300),
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              leading: CircleAvatar(
                                backgroundColor:
                                    _statusColor(index).withValues(alpha: 0.1),
                                child: Icon(
                                  _statusIcon(index),
                              ...
                              trailing: PopupMenuButton<String>(
                                onSelected: (value) => ref
                                    ...
                                    .updateStatus(order['id']?.toString() ?? '', value),
                                itemBuilder: (ctx) => [
                                  if (index < 2)
                                    const PopupMenuItem(
                                      value: 'processing',
