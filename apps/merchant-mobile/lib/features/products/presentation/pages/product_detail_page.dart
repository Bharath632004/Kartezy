              ...
              : SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        productState.selectedProduct!.description ?? 'No description',
                        style: Theme.of(context).textTheme.bodyText2,
                      ),
                      const SizedBox(height: 16),
                      const Divider(),
                      ...
                      const SizedBox(height: 4),
                      _buildInfoRow(
                          'Category', productState.selectedProduct!.categoryId ?? 'N/A'),
                      _buildInfoRow(
                          'Brand', productState.selectedProduct!.brandId ?? 'N/A'),
                      _buildInfoRow(
                          'Weight',
                      ...
                      _buildInfoRow(
                          'Barcode', productState.selectedProduct!.barcode ?? 'N/A'),
                      _buildInfoRow(
                          'HSN Code', productState.selectedProduct!.hsnCode ?? 'N/A'),
                      _buildInfoRow(
                          'MRP',
