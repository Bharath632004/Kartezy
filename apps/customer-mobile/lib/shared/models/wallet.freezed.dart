...
class _$WalletImpl implements _Wallet {
  const _$WalletImpl({required this.balance, this.currency, this.lastUpdated});
  ...
  @override
  String toString() {
    return 'Wallet(balance: $balance, currency: $currency, lastUpdated: $lastUpdated)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, balance, currency, lastUpdated);
