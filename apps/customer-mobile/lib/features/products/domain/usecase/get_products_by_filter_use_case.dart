...
class GetProductsByFilterUseCase {
  ...
  Future<List<Product>> call(String filter) => _repository.getProductsByFilter(filter);
}

/// Provider for get products by filter use case
final getProductsByFilterUseCaseProvider = Provider<GetProductsByFilterUseCase>((ref) {
