...
class _$TrackingInfoImpl implements _TrackingInfo {
  ...
  @override
  String toString() {
    return 'TrackingInfo(orderId: $orderId, driver: $driver, route: $route, currentStatus: $currentStatus, lastUpdated: $lastUpdated, distanceRemaining: $distanceRemaining, eta: $eta, currentLatitude: $currentLatitude, currentLongitude: $currentLongitude)';
  }
...
abstract class _TrackingInfo implements TrackingInfo {
  const factory _TrackingInfo(
      ...
      required final double currentLongitude}) = _$TrackingInfoImpl;
