...
abstract class $OrderTimelineCopyWith<$Res> {
  factory $OrderTimelineCopyWith(
    OrderTimeline value,
    $Res Function(OrderTimeline) then,
...
abstract class _$$OrderTimelineImplCopyWith<$Res>
  ...
  factory _$$OrderTimelineImplCopyWith(
    _$OrderTimelineImpl value,
    $Res Function(_$OrderTimelineImpl) then,
...
class __$$OrderTimelineImplCopyWithImpl<$Res>
  ...
  __$$OrderTimelineImplCopyWithImpl(
    _$OrderTimelineImpl _value,
    $Res Function(_$OrderTimelineImpl) _then,
  ) : super(_value, _then);
...
class _$OrderTimelineImpl implements _OrderTimeline {
  ...
  @override
  String toString() {
    return 'OrderTimeline(id: $id, orderId: $orderId, status: $status, description: $description, timestamp: $timestamp, updatedBy: $updatedBy)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$OrderTimelineImplToJson(this);
  }
}
