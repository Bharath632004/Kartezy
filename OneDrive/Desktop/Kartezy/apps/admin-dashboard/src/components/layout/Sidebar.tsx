  ...
  return (
    <Box sx={{ width: '100%', flexShrink: 0 }}>
      ...
      <List>
        ...
        {/* BI Platform */}
        <ListItemButton onClick={() => router.push('/dashboard/bi/executive-dashboard')}
          sx={{ '&:hover': { bgcolor: 'action.hover' } }}
        >
          <ListItemIcon><AssessmentIcon /></ListItemIcon>
          <ListItemText primary="BI Platform" />
        </ListItemButton>
        ...
        {openState.reports && (
          <Collapse in={true} timeout="auto" unmountOnExit>
            <List component="div" disablePadding>
              <ListItem button sx={{ pl: 3 }} onClick={() => router.push('/dashboard/bi/board-reports')}>
                <ListItemIcon>📊</ListItemIcon>
                <ListItemText primary="Board Reports" />
              </ListItem>
              <ListItem button sx={{ pl: 3 }} onClick={() => router.push('/dashboard/bi/kpi-dashboard')}>
                <ListItemIcon>📈</ListItemIcon>
                <ListItemText primary="KPI Dashboard" />
              </ListItem>
              <ListItem button sx={{ pl: 3 }} onClick={() => router.push('/dashboard/bi/customer-analytics')}>
                <ListItemIcon>👥</ListItemIcon>
                <ListItemText primary="Customer Analytics" />
              </ListItem>
              <ListItem button sx={{ pl: 3 }} onClick={() => router.push('/dashboard/bi/merchant-analytics')}>
                <ListItemIcon>🏪</ListItemIcon>
                <ListItemText primary="Merchant Analytics" />
              </ListItem>
              <ListItem button sx={{ pl: 3 }} onClick={() => router.push('/dashboard/bi/delivery-analytics')}>
                <ListItemIcon>🚚</ListItemIcon>
                <ListItemText primary="Delivery Analytics" />
              </ListItem>
              <ListItem button sx={{ pl: 3 }} onClick={() => router.push('/dashboard/bi/finance-analytics')}>
                <ListItemIcon>💰</ListItemIcon>
                <ListItemText primary="Finance Analytics" />
              </ListItem>
              <ListItem button sx={{ pl: 3 }} onClick={() => router.push('/dashboard/bi/product-analytics')}>
                <ListItemIcon>📦</ListItemIcon>
                <ListItemText primary="Product Analytics" />
              </ListItem>
              <ListItem button sx={{ pl: 3 }} onClick={() => router.push('/dashboard/bi/city-analytics')}>
                <ListItemIcon>🌆</ListItemIcon>
                <ListItemText primary="City Analytics" />
              </ListItem>
              <ListItem button sx={{ pl: 3 }} onClick={() => router.push('/dashboard/bi/marketing-analytics')}>
                <ListItemIcon>📢</ListItemIcon>
