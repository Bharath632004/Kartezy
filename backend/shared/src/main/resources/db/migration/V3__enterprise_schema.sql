-- ============================================================
-- Flyway Migration V3: Enterprise Scalability Schema
-- Multi-Tenant, Multi-City/State/Country, Multi-Language,
-- Multi-Currency, Multi-Timezone, Warehouse, Marketplace
-- ============================================================
...
-- Purchase orders for vendor procurement
...
-- Seed data - Default countries and tenant
...
INSERT INTO kartezy_enterprise.countries (name, code, iso_code, iso_code2, calling_code, currency_code, default_locale, default_timezone)
VALUES ('Singapore', 'SG', 'SGP', 'SG', '+65', 'SGD', 'en_SG', 'Asia/Singapore')
ON CONFLICT (code) DO NOTHING;
